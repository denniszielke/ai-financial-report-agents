...
{} \
Your job is to give extensive and detailed feedback on the financial analyst statements and recommend concrete recommendations on what should be added, removed or changed to improve the quality of the insights in the report.\
Insights:\n {} \
Statements: \n {}"
...
def handle_analyst(state):
    ...
    analsis = model_response(analyst_start.format(specialization,add_analyst_prompt, feedback,statements,insights))
